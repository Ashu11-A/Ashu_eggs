...
if [ ! -f "./logs/config_nginx" ] || [ ! -f "./nginx/conf.d/default.conf" ]; then
    (
        ...
        rm default.conf
        curl -sO https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Uguu/default.conf
    )
...
if [[ -d "./Uguu" ]]; then
    ...
    curl -sSL https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Uguu/start.sh -o start.sh
    chmod a+x ./start.sh
    bash <(curl -s https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Uguu/launch.sh)
else
