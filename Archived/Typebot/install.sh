...
if [ -f "/home/container/nginx/nginx.conf" ]; then
    ...
    curl -sSL https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Typebot/default.conf -o ./nginx/conf.d/default.conf
    sed -i \
...
if [[ -f "./logs/typebot_instalado" ]]; then
    bash <(curl -s https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Typebot/version.sh)
    bash <(curl -s https://raw.githubusercontent.com/Ashu11-A/Ashu_eggs/main/Connect/en/Typebot/launch.sh)
else
